package section_19_databases._02_musicdb.model;
...
//      }
        ...
        try (Statement statement = conn.createStatement();
            ...
            System.out.println("Qery failed: " + e.getMessage());
            return null;
        }
    }
...
//        }
    ...
    // Transaction for inserting a song into the database
    public void insertSong(String title, String artist, String album, int track) {
        try {
            ...
            try {
                ...
                System.out.println("Even the rollback failed. Things are really bad");
            }
        } finally {
            try {
